...
main(int argc, char *argv[])
{
  ...
  47:	e8 2c 03 00 00       	call   378 <mkdir>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 439:	0f b6 80 0c 0b 00 00 	movzbl 0xb0c(%eax),%eax
...
printf(int fd, const char *fmt, ...)
{
 ...
 596:	75 09                	jne    5a1 <printf+0x101>
          s = "(null)";
 598:	c7 45 f4 9f 08 00 00 	movl   $0x89f,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 662:	a1 28 0b 00 00       	mov    0xb28,%eax
 ...
 72d:	a3 28 0b 00 00       	mov    %eax,0xb28
}
 732:	c9                   	leave  
 733:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 780:	e8 ce fe ff ff       	call   653 <free>
  return freep;
 785:	a1 28 0b 00 00       	mov    0xb28,%eax
}
 78a:	c9                   	leave  
 78b:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7af:	c7 45 f0 20 0b 00 00 	movl   $0xb20,-0x10(%ebp)
 7b6:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7b9:	a3 28 0b 00 00       	mov    %eax,0xb28
 7be:	a1 28 0b 00 00       	mov    0xb28,%eax
 7c3:	a3 20 0b 00 00       	mov    %eax,0xb20
    base.s.size = 0;
 7c8:	c7 05 24 0b 00 00 00 	movl   $0x0,0xb24
 7cf:	00 00 00 
  }
 ...
 825:	a3 28 0b 00 00       	mov    %eax,0xb28
      return (void*)(p + 1);
 ...
 830:	eb 38                	jmp    86a <malloc+0xde>
    ...
    if(p == freep)
 832:	a1 28 0b 00 00       	mov    0xb28,%eax
