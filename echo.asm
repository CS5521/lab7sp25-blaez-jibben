...
main(int argc, char *argv[])
{
  ...
  54:	e8 24 04 00 00       	call   47d <printf>
  for(i = 1; i < argc; i++)
  ...
  exit();
  67:	e8 81 02 00 00       	call   2ed <exit>
...
gets(char *buf, int max)
{
 ...
 1a3:	e8 5d 01 00 00       	call   305 <read>
...
stat(const char *n, struct stat *st)
{
 ...
 208:	e8 20 01 00 00       	call   32d <open>
...
void ps() {
 ...
 2cf:	81 ec 18 09 00 00    	sub    $0x918,%esp
  pstatTable p;
  getpinfo(&p);
 2d5:	8d 85 f8 f6 ff ff    	lea    -0x908(%ebp),%eax
 2db:	89 04 24             	mov    %eax,(%esp)
 2de:	e8 aa 00 00 00       	call   38d <getpinfo>
 2e3:	c9                   	leave  
 2e4:	c3                   	ret    
...
putc(int fd, char c)
{
 ...
 3be:	e8 4a ff ff ff       	call   30d <write>
}
 3c3:	c9                   	leave  
 3c4:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 416:	0f b6 80 c0 0a 00 00 	movzbl 0xac0(%eax),%eax
...
printf(int fd, const char *fmt, ...)
{
 ...
 573:	75 09                	jne    57e <printf+0x101>
          s = "(null)";
 575:	c7 45 f4 52 08 00 00 	movl   $0x852,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 63f:	a1 dc 0a 00 00       	mov    0xadc,%eax
 ...
 70a:	a3 dc 0a 00 00       	mov    %eax,0xadc
}
 70f:	c9                   	leave  
 710:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 730:	e8 40 fc ff ff       	call   375 <sbrk>
 ...
 75d:	e8 ce fe ff ff       	call   630 <free>
  return freep;
 762:	a1 dc 0a 00 00       	mov    0xadc,%eax
}
 767:	c9                   	leave  
 768:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 77b:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 77e:	a1 dc 0a 00 00       	mov    0xadc,%eax
 783:	89 45 f0             	mov    %eax,-0x10(%ebp)
 786:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 78a:	75 23                	jne    7af <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 78c:	c7 45 f0 d4 0a 00 00 	movl   $0xad4,-0x10(%ebp)
 793:	8b 45 f0             	mov    -0x10(%ebp),%eax
 796:	a3 dc 0a 00 00       	mov    %eax,0xadc
 79b:	a1 dc 0a 00 00       	mov    0xadc,%eax
 7a0:	a3 d4 0a 00 00       	mov    %eax,0xad4
    base.s.size = 0;
 7a5:	c7 05 d8 0a 00 00 00 	movl   $0x0,0xad8
 7ac:	00 00 00 
  }
 ...
 802:	a3 dc 0a 00 00       	mov    %eax,0xadc
      return (void*)(p + 1);
 ...
 80d:	eb 38                	jmp    847 <malloc+0xde>
    ...
    if(p == freep)
 80f:	a1 dc 0a 00 00       	mov    0xadc,%eax
