...
printf(int fd, const char *s, ...)
{
  ...
  22:	e8 8f 03 00 00       	call   3b6 <write>
}
  27:	c9                   	leave  
  28:	c3                   	ret    
...
forktest(void)
{
  ...
  4a:	eb 1f                	jmp    6b <forktest+0x42>
    pid = fork();
  4c:	e8 3d 03 00 00       	call   38e <fork>
  ...
  60:	75 05                	jne    67 <forktest+0x3e>
      exit();
  62:	e8 2f 03 00 00       	call   396 <exit>
  for(n=0; n<N; n++){
  ...
  94:	e8 67 ff ff ff       	call   0 <printf>
    exit();
  99:	e8 f8 02 00 00       	call   396 <exit>
  }

  for(; n > 0; n--){
  9e:	eb 26                	jmp    c6 <forktest+0x9d>
    if(wait() < 0){
  a0:	e8 f9 02 00 00       	call   39e <wait>
  ...
  b8:	e8 43 ff ff ff       	call   0 <printf>
      exit();
  bd:	e8 d4 02 00 00       	call   396 <exit>
  for(; n > 0; n--){
  ...
  if(wait() != -1){
  cc:	e8 cd 02 00 00       	call   39e <wait>
  ...
  e5:	e8 16 ff ff ff       	call   0 <printf>
    exit();
  ea:	e8 a7 02 00 00       	call   396 <exit>
  }
...
main(void)
{
 ...
 10b:	e8 19 ff ff ff       	call   29 <forktest>
  exit();
 110:	e8 81 02 00 00       	call   396 <exit>
...
gets(char *buf, int max)
{
 ...
 24c:	e8 5d 01 00 00       	call   3ae <read>
...
stat(const char *n, struct stat *st)
{
 ...
 2b1:	e8 20 01 00 00       	call   3d6 <open>
...
void ps() {
 ...
 378:	81 ec 18 09 00 00    	sub    $0x918,%esp
  pstatTable p;
  getpinfo(&p);
 37e:	8d 85 f8 f6 ff ff    	lea    -0x908(%ebp),%eax
 384:	89 04 24             	mov    %eax,(%esp)
 387:	e8 aa 00 00 00       	call   436 <getpinfo>
 38c:	c9                   	leave  
 38d:	c3                   	ret    
